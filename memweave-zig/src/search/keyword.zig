...
const stop_words_en: []const []const u8 = &.{
    "a",         "about",    "above",     "after",   "ago",       "an",
    "and",       "anything", "are",       "as",      "at",        "be",
    "because",   "been",     "before",    "being",   "below",     "between",
    "but",       "by",       "can",       "could",   "did",       "do",
    "does",      "during",   "earlier",   "everything", "find",   "for",
    "from",      "get",      "give",      "had",     "has",       "have",
    "he",        "help",     "how",       "i",       "if",        "in",
    "into",      "is",       "it",        "just",    "later",     "may",
    "me",        "might",    "my",        "nothing", "now",       "of",
    "on",        "or",       "our",       "over",    "please",    "recently",
    "she",       "should",   "show",      "something", "stuff",   "tell",
    "that",      "the",      "them",      "then",    "these",     "they",
    "thing",     "things",   "this",      "those",   "through",   "to",
    "today",     "tomorrow", "under",     "was",     "we",        "were",
    "what",      "when",     "where",     "which",   "while",     "who",
    "why",       "will",     "with",      "would",   "yesterday", "you",
    "your",
};

const stop_words_es: []const []const u8 = &.{
    "a",       "ahora",    "antes",    "ayer",     "ayuda",   "como",
    "con",     "cuando",   "cuándo",   "cómo",     "de",      "del",
    "despues", "después",  "donde",    "dónde",    "el",      "ellas",
    "ellos",   "en",       "entre",    "es",       "esa",     "ese",
    "esta",    "estar",    "este",     "favor",    "fue",     "fueron",
    "haber",   "hacer",    "hoy",      "la",       "las",     "los",
    "mañana",  "me",       "mi",       "nosotras", "nosotros", "o",
    "para",    "pero",     "por",      "porque",   "porquê",  "que",
    "qué",     "recientemente", "ser", "si",       "sobre",   "son",
    "tener",   "tu",       "tus",      "un",       "una",     "unas",
    "unos",    "usted",    "ustedes",  "y",        "yo",
};

const stop_words_pt: []const []const u8 = &.{
    "a",       "agora",   "ajuda",   "amanhã",  "antes",   "as",
    "com",     "como",    "da",      "de",      "depois",  "do",
    "e",       "ela",     "elas",    "ele",     "eles",    "em",
    "entre",   "essa",    "esse",    "esta",    "estar",   "este",
    "eu",      "favor",   "fazer",   "foi",     "foram",   "hoje",
    "mas",     "me",      "meu",     "minha",   "nos",     "nós",
    "o",       "onde",    "ontem",   "os",      "ou",      "para",
    "por",     "porque",  "porquê",  "quando",  "que",     "quê",
    "recentemente", "se", "ser",     "sobre",   "são",     "ter",
    "um",      "uma",     "umas",    "uns",     "você",    "vocês",
    "é",
};

const stop_words_ar: []const []const u8 = &.{
    "أصبح",  "أنا",  "أو",   "أين",  "إلى",  "ال",
    "الآن",  "الى",  "اليوم", "امس",  "ب",    "بالأمس",
    "بعد",   "بل",   "بين",  "تكون", "تلك",  "ثم",
    "ذلك",   "ساعد", "صار",  "على",  "عن",   "غدا",
    "فضلا",  "في",   "قبل",  "ك",    "كان",  "كانت",
    "كيف",   "ل",    "لكن",  "لماذا", "مؤخرا", "ماذا",
    "متى",   "مع",   "ممكن", "من",   "من فضلك", "نحن",
    "هذا",   "هذه",  "هل",   "هم",   "هنا",  "هناك",
    "هو",    "هي",   "و",    "يكون", "يمكن",
};
